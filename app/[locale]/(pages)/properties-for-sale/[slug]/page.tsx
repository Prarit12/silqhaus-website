...
export async function generateMetadata({
  ...
  try {
    ...
    if (!listing.listingType?.includes("SALE")) {
      return {
        title: t("notFound"),
    ...
    return {
      ...
      description,
      alternates: {
        canonical: `${baseUrl}/${locale}/properties-for-sale/${listing.slug}`,
      },
      openGraph: {
        title,
        description,
...
export default async function PropertyForSaleDetailPage({ params }: PageProps) {
  ...
  try {
    ...
    return <PMSDetailError basePath="properties-for-sale" />;
  }
  if (!listing || !listing.listingType?.includes("SALE")) {
    notFound();
  }
