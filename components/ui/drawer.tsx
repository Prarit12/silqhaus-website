...
const DIRECTION_CLASSES: Record<DrawerDirection, string> = {
  ...
  top: "inset-x-0 top-0 mb-24 flex h-auto flex-col rounded-b-[10px] border",
  right:
    "inset-y-0 right-0 mt-0 flex h-full w-full sm:max-w-md flex-col rounded-l-[10px] border-l",
  left: "inset-y-0 left-0 mt-0 flex h-full w-full sm:max-w-md flex-col rounded-r-[10px] border-r",
};
