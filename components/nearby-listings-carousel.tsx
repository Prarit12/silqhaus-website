          ...
          {listings.map((listing) => {
            ...
            return (
              <Link
                ...
                className="flex-none w-64 sm:w-72 md:w-80 lg:w-72 xl:w-80 2xl:w-96 group cursor-pointer rounded-lg overflow-hidden relative border border-white/10 hover:border-[#ffffff]/40 focus:outline-none focus:ring-2 focus:ring-[#ffffff]/20 transition-all duration-300 hover:scale-[1.02]"
              >
