  ...
  return (
    <main className="min-h-screen bg-bg flex items-center justify-center px-4 py-24">
      <div className="max-w-md w-full text-center">
        <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#ffffff]/15 text-[#ffffff] mb-6">
        ...
        <Link
          href={`/${basePath}`}
          className="inline-flex items-center gap-2 px-5 py-2.5 rounded-lg bg-[#ffffff] hover:bg-[#6b5a20] text-white font-poppins text-sm transition-colors"
        >
          <ArrowLeft size={16} />
          {tList("backToList")}
        </Link>
