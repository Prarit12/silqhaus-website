...
/**
 * White OTA logo lockups, shared by the PM distribution strip and the
 * About Us ratings banner. All inherit currentColor.
 */

export function AirbnbLockup() {
  return <AirbnbLogo className="h-[30px] w-auto" />;
}

export function BookingLockup() {
  return (
    <span className="inline-flex items-center gap-2">
      ...
      <span className="text-[21px] font-bold tracking-tight">Booking.com</span>
    </span>
  );
}

export function ExpediaLockup() {
  return (
    <span className="inline-flex items-center gap-2">
      <span className="inline-flex h-[22px] w-[22px] items-center justify-center overflow-hidden rounded-[5px]">
        <svg
      ...
      <span className="text-[21px] font-semibold tracking-tight">Expedia</span>
    </span>
  );
}

export function AgodaLockup() {
  return (
    <span className="inline-flex flex-col items-center gap-[5px]">
...
export function VrboLockup() {
  return <VrboLogo className="h-[30px] w-auto" />;
}

export function TripLockup() {
  return (
    <span className="inline-flex items-center text-[21px] font-bold tracking-tight">
      Trip
